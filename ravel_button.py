...
while True:
    #driver = webdriver.Chrome(executable_path=r"C:/Users/doyle/Documents/chromedriver.exe")  # Optional argument, if not specified will search path.
    ...
    # button = driver.find_element_by_id('"home_available_element full">')
    button = driver.find_element_by_class_name('home_available_element')

    print(button)
    button.click()
    available_room = driver.find_element_by_class_name('option.openbox')
